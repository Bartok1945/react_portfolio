...
function AboutMe(props) {
    <div className="aboutMe">
        ...
        <div className="container">
                    ...
                    <blockquote className="blockquote mb-0">
                        <div className="row">
                            <div className="col-md-3">
                                <img src="assets\rsz_10.png" class="hs" />
          ...
          <h4>Download Resume <a href="assets\ThomHuengerResume.pdf" download>Here</a></h4>
                                        <h4>Visit my <a href="https://www.linkedin.com/in/thom-huenger-b81893158/">LinkedIn</a> </h4>
                                    </p>
